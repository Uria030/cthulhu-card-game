...
- 狀態:待審(已交接、已整理 repo 交件、尚未送 HUB review)
...
2. [待執行] 依 `docs/_codex_handoff/README.md` 送 HUB Hammon review,審查本輪是否符合工單邊界與視覺紅線。
3. Hammon PASS 後,進入四席人影校準小樣;本階段不接 runtime、不開全量量產。
