...
DO $$ BEGIN
  ALTER TABLE campaigns ADD COLUMN campaign_type VARCHAR(8) NOT NULL DEFAULT 'main'
    CHECK (campaign_type IN ('main','side'));
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE campaigns ADD COLUMN chapter_count INTEGER NOT NULL DEFAULT 10
